...
def build_dataset(
    ...
    # train_random_list = random.sample(range(0, 4998 + 1), int(0.6 * 5000))
    # val_random_list = random.sample(
    #     set(range(0, 4998 + 1)) - set(train_random_list), int(0.2 * 5000)
    # )
    # with open(f"data/train_random_list_0.6.json", "w") as file:
    #     json.dump(train_random_list, file)
    # with open(f"data/val_random_list_0.6.json", "w") as file:
    #     json.dump(val_random_list, file)
